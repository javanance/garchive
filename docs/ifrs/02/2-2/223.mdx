...
구성요소분리와 관련하여 내재파생상품 및 투자요소 분리방안에 대한 내용을 정리하고 IFRS 17에 따른 적용방안에 대해 검토함.
...
기준서 문단 B31에 따라 보험요소와 투자요소 간 높은 상호 연관성이 존재하지 않고 투자요소와 동등한 조건을 가진 계약이 동일 시장 혹은 동일 관할권 내에서 보험자 또는 다른 상대방에 의해 별도로 판매가 가능한 경우 투자요소를 주계약으로부터 분리 가능함.
...
<Fieldset legend="[참고] 2019년 4월 TRG '보험계약의 투자요소'" toggleable>
...
---
<CenterImg src="/ifrs/tbl2-12.png" width={700} caption="[투자요소 판단 관련 IASB 사례]" />
---
...
---
<CenterImg src="/ifrs/tbl2-13.png" width={700} caption="[상품별 투자요소]" />
---
