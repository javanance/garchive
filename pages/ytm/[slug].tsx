...
export async function getStaticPaths() {
    ...
    const yymmList = ['202201', '202202', '202203', '202204', '202205', '202206', '202207', '202208', '202209', '202210', '202211', '202212',
                      '202301', '202302', '202303', '202304', '202305', '202306', '202307'
                        ]

    const paths = yymmList.map((aa) => ({
        params: { slug: aa },
      }))
...
// console.log('props : ' + props.slug)
  ...
  const baseYymm = selectedCity? slug: selectedCity;

  const cities = [
        { name: '202201', code: '202201' },
        { name: '202202', code: '202202' },
        { name: '202203', code: '202203' },
        { name: '202204', code: '202204' },
        { name: '202306', code: '202306' }
    ];
  ...
  const columns = [
      ...
      {field: 'large_category_mrk', header: '금리유형'},
      {field: 'credit_rnk_mrk', header: '신용등급'},
      ...
      <>
          ...
          <div className="card flex justify-content-center">
           <Dropdown value={selectedCity} onChange={(e) => setSelectedCity(e.value)} options={cities} optionLabel="name"
               placeholder="Select YYYYMM" className="w-full md:w-14rem" />
       </div>
...
ytmPage.getLayout = function getLayout(page) {
  // const {models} = JSON;
