...
import {Button, Accordion, AccordionTab, Card, Panel, TabView, TabPanel, OverlayPanel, DataTable, Column, Fieldset, Callout, M1, G2Col, GSheet, Math, Image, SubText, Cmt, CenterImg, Chip}  from '@/components/prime'
...
const usedcomponents = {
  ...
  , Callout, M1, G2Col, GSheet, Math, OverlayDemo, Image, SubText, Cmt, CenterImg, Chip
};
