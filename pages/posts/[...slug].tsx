...
import {Accordion, AccordionTab, Card, Panel, TabView, TabPanel, OverlayPanel, GSheet, DataTable, Column, Image}  from '@/components/prime'
...
const usedcomponents = {
  Accordion, AccordionTab, Card, Panel, TabView, TabPanel, OverlayPanel, GSheet, DataTableDemo, Image
};
